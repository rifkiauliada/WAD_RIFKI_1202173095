        ...
        <div class="row">
            <div class="pt-5">
                <div class="card shadow-lg p-3 mb-5 bg-body rounded">
                    <form action="Rifki_crud.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <h1 class="card-title text-center"><b>Tambah Data Buku</b></h1>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="judul_buku" id="judul_buku" placeholder="Contoh: Pemograman Web Bersama EAD">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="tahun_terbit" id="tahun_terbit" placeholder="Contoh: 1922">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Deskripsi</label>
                                <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Contoh: Buku ini menjelaskan tentang . . . ." style="height: 100px"></textarea>
                            </div>
